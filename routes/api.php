...
Route::prefix("v1")->group(function () {
    Route::prefix("bands")->group(function () {
        ...
        Route::get("/id/{bandId}", "App\Http\Controllers\BandsController@getById")->name("bands.getById");
        Route::get("/gender/{bandGender}", "App\Http\Controllers\BandsController@getByGender")->name("bands.getByGender");
